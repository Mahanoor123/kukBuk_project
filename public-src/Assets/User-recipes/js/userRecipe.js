...
import { getFirestore, where } from "https://www.gstatic.com/firebasejs/11.3.1/firebase-firestore.js";
...
import { collection, doc, getDocs, getDoc, query, orderBy, deleteDoc, updateDoc, setDoc, onSnapshot, } from '/firebase/firebase-config.js';
    ...
    if (user) {
      ...
      try {
        ...
        if (userCollection.length == 0) {
          console.log("userCollection = 0 , No-recipies.");
        }

        else {
          console.log("User Collection:", userCollection); // Log the user collection
